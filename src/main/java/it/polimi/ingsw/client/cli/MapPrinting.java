...
public class MapPrinting {
    ...
    public String[][] map = new String[maxVerticalLength][maxHorizontalLength];
    ...
    public void fillMapWithAmmoAndCoord(){
    ...
    private void fillCoord(int r, int c) {
    ...
    private void fillCliSpot(int r, int c, JsonObject jsonSpot) {
    ...
    private void fillAmmoWithPowerUp(int r, int c) {
        map[r][c] = "P";
    }

    private void fillAmmoColorList(int r, int c, Color ammoColor) {
        map[r][c] = ammoColor.escape() + "A" + Color.RESET;
    }


    public void printMyShit(){
